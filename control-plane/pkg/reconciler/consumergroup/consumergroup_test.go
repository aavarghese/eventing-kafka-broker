...
func TestReconcileKind(t *testing.T) {
	...
	tt := TableTest{
		...
		},
		{
			...
			WantCreates: []runtime.Object{
				NewKedaSecret(ConsumerGroupNamespace, "test-cg-secret"),
				NewConsumer(1,
					ConsumerSpec(NewConsumerSpec(
						ConsumerTopics("t1", "t2"),
						ConsumerConfigs(
...
func createNewAction() clientgotesting.GetActionImpl {
	action := clientgotesting.GetActionImpl{}
	action.Resource = keda.KedaSchemeGroupVersion.WithResource("")
	action.Name = ConsumerGroupName
	return action
}
